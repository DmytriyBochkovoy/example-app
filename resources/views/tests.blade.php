                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="{{ route('edit-test', $test->id) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row pt-5 my-5">
                <div class="col-12 d-flex justify-content-center">
                    ...
                    <div class="text-center mx-5">
                        <a class="btn btn-success" href="{{ route('question-form') }}">Добавить вопрос к тесту</a>
                    </div>
                </div>
            </div>
        </div>
